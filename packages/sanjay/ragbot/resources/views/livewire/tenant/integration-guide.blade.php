<div>
    ...
    <div class="flex gap-2 mb-8 border-b border-zinc-200 dark:border-zinc-800 pb-px">
        ...
        <a 
            href="{{ route('ragbot.developer-extension', ['project_slug' => $project->slug]) }}" 
            wire:navigate
            class="px-4 py-2 text-sm font-medium transition-colors border-b-2 border-transparent text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300"
        >
            <div class="flex items-center gap-2">
