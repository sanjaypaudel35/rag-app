...
@section("content")
    ...
    <form method="POST" action="{{ route("ragbot.tenant.login.store", ["project_slug" => request()->route("project_slug")]) }}">
        @csrf
        ...
        <div class="mt-4 text-center">
            <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100" href="{{ route("ragbot.tenant.register", ["project_slug" => request()->route("project_slug")]) }}">
