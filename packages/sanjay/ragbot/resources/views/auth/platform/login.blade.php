...
@section("content")
    ...
    <form method="POST" action="{{ route("ragbot.login.store") }}">
        @csrf
        ...
        <div class="mt-4 text-center">
            <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100" href="{{ route("ragbot.register") }}">
